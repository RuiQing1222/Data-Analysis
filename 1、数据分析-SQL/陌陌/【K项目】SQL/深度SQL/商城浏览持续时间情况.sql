...
round(avg(账户浏览商城时间)/60000,2) as '账户平均浏览时长(分钟)'
from
(
select role_level, user_id, avg(time_interval) as '账户浏览商城时间'
from
(
...
FROM fairy_town_server.server_open_mall_panel o
left join fairy_town_server.server_close_mall_panel c
