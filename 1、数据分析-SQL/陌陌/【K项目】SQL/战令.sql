...
where
    server_id in (10001,10002,10003) 
    and log_time >= 1634875200000 and log_time <= 1637089200000
    and product_name = '战令'
...
where
    day_time <= 20211117
    and role_id in 
    (select role_id from (select distinct role_id from fairy_town.server_role_login where day_time >= 20211022 and day_time <= 20211117 and role_level >= 9
                    union all 
                    select distinct role_id from fairy_town.server_role_upgrade where day_time >= 20211022 and day_time <= 20211117 and role_level >= 9) w
    )
group by 1
...
select
    ...
    case when birth_dt >= '2021-10-22' and birth_dt <= '2021-11-17' then '活动内'
         else '活动之前'
         end as '是否活动期内',
     最后登录日期,
    case when 最后登录日期 < '2021-11-11' then '流失'
         else '留存'
         end as '是否流失', 
...
where day_time>=20211022 and day_time<=${endDate} 
...
SELECT day_time,
       sum(pay_price)
FROM fairy_town.order_pay
WHERE day_time>=20211022
  AND day_time<=20211117
  AND server_id IN (10001,10002,10003)
  AND product_name = '战令'
GROUP BY 1
ORDER BY 1
...
战令等级数据
-- 买战令的人
select distinct role_id from order_pay where server_id in (10001,10002,10003) and day_time >= 20211022 and day_time <= 20211117 and product_name = '战令'
-- 参与战令但是没买战令
select 
    distinct role_id
from 
...
where
    server_id in (10001,10002,10003) 
    and day_time >= 20211022 and day_time <= 20211117
    and role_id not in (select distinct role_id from order_pay where server_id in (10001,10002,10003) and day_time >= 20211022 and day_time <= 20211117 and product_name = '战令')
...
where 
    ...
    and role_id in (select distinct role_id from order_pay where server_id in (10001,10002,10003) and day_time >= 20211022 and day_time <= 20211117 and product_name = '战令')
group by 2
) a
left join
(
...
where server_id in (10001,10002,10003) and day_time >= 20211022 and day_time <= 20211117
group by 1
order by 1) as a
left join
...
and role_id in (select distinct role_id from fairy_town_server.server_battle_pass_task_triggered
                where
                    ...
                    and day_time >= 20211022 and day_time <= 20211117
                    and role_id not in 
                    (select distinct role_id from fairy_town.order_pay where server_id in (10001,10002,10003) and day_time >= 20211022 and day_time <= 20211117 and product_name = '战令')
               )
group by 1
order by 1) as e
...
where
    server_id in (10001,10002,10003) 
    and day_time >= 20211022 and day_time <= 20211026
    and role_id in (select role_id from fairy_town.server_role_login  where day_time>=20211017 and day_time<=20211021)
    and role_id in (select role_id from fairy_town.server_role_login  where day_time>=20211022 and day_time<=20211026))
...
where 
    ...
    (select distinct role_id
        from fairy_town.order_pay 
        where day_time>=20211022 and day_time<=20211026
        and product_name='战令'
        and role_id  in (select role_id from fairy_town.server_role_login  where day_time>=20211017 and day_time<=20211021)
        and role_id  in (select role_id from fairy_town.server_role_login  where day_time>=20211022 and day_time<=20211026)
        and role_id in (select distinct role_id from fairy_town_server.server_battle_pass_task_completed where server_id in (10001,10002,10003) and day_time >= 20211022 and day_time <= 20211026)
    )
    and day_time >= ${start_time}
    and day_time <= ${end_time}
...
where 
    ...
    where
        server_id in (10001,10002,10003) 
        and day_time >= 20211022 and day_time <= 20211026
        and role_id not in (select distinct role_id from fairy_town.order_pay where product_name = '战令' and day_time >= 20211022 and day_time <= 20211026)
        and role_id in (select role_id from fairy_town.server_role_login  where day_time>=20211017 and day_time<=20211021)
        and role_id in (select role_id from fairy_town.server_role_login  where day_time>=20211022 and day_time<=20211026)
    )
    and day_time >= ${start_time}
