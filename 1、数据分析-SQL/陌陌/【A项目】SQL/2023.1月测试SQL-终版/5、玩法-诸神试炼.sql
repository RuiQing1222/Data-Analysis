...
-- 关卡参与情况
left join
(select dungeon_id,role_id,start_time,game_type,battle_result,done_dt
from
(select a.dungeon_id,a.role_id,a.start_time,a.game_type,battle_result,done_dt
from 
(select dungeon_id,role_id,start_time,to_date(cast(date_time as timestamp)) as done_dt,game_type -- start_time也可用统计参与次数
...
left join     
(select dungeon_id,role_id,start_time,battle_result,game_type
...
select birth_dt,b.role_id,dungeon_id,scene_id,start_time,game_type,battle_result,battle_time,auto_battle,bottle_num,c.*
from
...
(select role_id,case when 天数 = 1 and sum_pay = 0 then 'D1免费',
               case when 天数 = 1 and (sum_pay > 0 and sum_pay <= 6) then 'D1小R',
               case when 天数 = 1 and (sum_pay > 6 and sum_pay <= 36) then 'D1中R',
               case when 天数 = 1 and (sum_pay > 36 and sum_pay <= 268) then 'D1大R',
               case when 天数 = 2 and sum_pay = 0 then 'D2免费',
               case when 天数 = 2 and (sum_pay > 0 and sum_pay <= 36) then 'D2小R',
               case when 天数 = 2 and (sum_pay > 36 and sum_pay <= 108) then 'D2中R',
               case when 天数 = 2 and (sum_pay > 108 and sum_pay <= 566) then 'D2大R',
               case when 天数 = 3 and sum_pay = 0 then 'D3免费',
               case when 天数 = 3 and (sum_pay > 0 and sum_pay <= 66) then 'D3小R',
               case when 天数 = 3 and (sum_pay > 66 and sum_pay <= 274) then 'D3中R',
               case when 天数 = 3 and (sum_pay > 274 and sum_pay <= 852) then 'D3大R',
               case when 天数 = 4 and sum_pay = 0 then 'D4免费',
               case when 天数 = 4 and (sum_pay > 0 and sum_pay <= 78) then 'D4小R',
               case when 天数 = 4 and (sum_pay > 78 and sum_pay <= 500) then 'D4中R',
               case when 天数 = 4 and (sum_pay > 500 and sum_pay <= 882) then 'D4大R',
               case when 天数 = 5 and sum_pay = 0 then 'D5免费',
               case when 天数 = 5 and (sum_pay > 0 and sum_pay <= 78) then 'D5小R',
               case when 天数 = 5 and (sum_pay > 78 and sum_pay <= 628) then 'D5中R',
               case when 天数 = 5 and (sum_pay > 628 and sum_pay <= 912) then 'D5大R',
               case when 天数 = 6 and sum_pay = 0 then 'D6免费',
               case when 天数 = 6 and (sum_pay > 0 and sum_pay <= 78) then 'D6小R',
               case when 天数 = 6 and (sum_pay > 78 and sum_pay <= 628) then 'D6中R',
               case when 天数 = 6 and (sum_pay > 628 and sum_pay <= 942) then 'D6大R',
               case when 天数 = 7 and sum_pay = 0 then 'D7免费',
               case when 天数 = 7 and (sum_pay > 0 and sum_pay <= 78) then 'D7小R',
               case when 天数 = 7 and (sum_pay > 78 and sum_pay <= 628) then 'D7中R',
               case when 天数 = 7 and (sum_pay > 628 and sum_pay <= 972) then 'D7大R',
               case when 天数 = 14 and sum_pay = 0 then 'D14免费',
               case when 天数 = 14 and (sum_pay > 0 and sum_pay <= 78) then 'D14小R',
               case when 天数 = 14 and (sum_pay > 78 and sum_pay <= 628) then 'D14中R',
               case when 天数 = 14 and (sum_pay > 628 and sum_pay <= 1182) then 'D14大R',
               case when 天数 = 30 and sum_pay = 0 then 'D30免费',
               case when 天数 = 30 and (sum_pay > 0 and sum_pay <= 78) then 'D30小R',
               case when 天数 = 30 and (sum_pay > 78 and sum_pay <= 628) then 'D30中R',
               case when 天数 = 30 and (sum_pay > 628 and sum_pay <= 1662) then 'D30大R',
from
